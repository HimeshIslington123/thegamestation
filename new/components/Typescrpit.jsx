      ...
      <div className="flex gap-[10px] md:gap-[20px] md:mt-[20px]">
        ...
        >
          <button
            ...
            className="relative inline-flex h-12 md:h-16 mt-[20px] overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50"
          >
